...
class WarrantyCoverage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WarrantyCoverage', package: const $pb.PackageName(_omitMessageNames ? '' : 'moat.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Struct>(9, _omitFieldNames ? '' : 'details', subBuilder: $3.Struct.create)
  ...
  @$pb.TagNumber(3)
  void clearCompanyId() => clearField(3);
  ...
  @$pb.TagNumber(6)
  void clearExpirationInMonths() => clearField(6);
  ...
  @$pb.TagNumber(7)
  void clearPageNumber() => clearField(7);
  ...
  @$pb.TagNumber(11)
  set endDate($0.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  void clearIsExpired() => clearField(13);
  ...
  @$pb.TagNumber(14)
  void clearDaysRemaining() => clearField(14);
...
class ListWarrantyCoveragesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<WarrantyCoverage> get coverages => $_getList(0);
...
class CreateWarrantyCoverageRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  void clearExpirationInMonths() => clearField(4);
...
class UpdateWarrantyCoverageRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  void clearUpdateFileAll() => clearField(8);
}
...
class WarrantyCoverageHistory extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearCoverageId() => clearField(2);
...
class AddCoverageHistoryRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  void clearCoverageId() => clearField(1);
...
class GetCoverageHistoryResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<WarrantyCoverageHistory> get history => $_getList(0);
}
