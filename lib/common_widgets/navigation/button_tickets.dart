...
class ButtonTickets extends StatelessWidget {
  const ButtonTickets({super.key, this.selected = false, this.onTap});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('Tickets', style: AppTextStyles.text2XSSemiBoldTertiary),
      ],
    );
  }
}
