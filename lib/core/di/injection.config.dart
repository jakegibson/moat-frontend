...
import '../../features/admin/state/admin_org_state.dart' as _i567;
...
import '../../features/explore/data/explore_client.dart' as _i464;
import '../../features/explore/state/dashboard_state.dart' as _i512;
...
import '../transport/admin_service_client.dart' as _i611;
import '../transport/analytics_service_client.dart' as _i587;
import '../transport/asset_service_client.dart' as _i621;
import '../transport/auth_service_client.dart' as _i230;
import '../transport/dashboard_service_client.dart' as _i1024;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i611.AdminServiceClient>(
        () => _i611.AdminServiceClient(gh<_i691.Transport>()));
    gh.lazySingleton<_i587.AnalyticsServiceClient>(
        () => _i587.AnalyticsServiceClient(gh<_i691.Transport>()));
    gh.lazySingleton<_i621.AssetServiceClient>(
        () => _i621.AssetServiceClient(gh<_i691.Transport>()));
    gh.lazySingleton<_i230.AuthServiceClient>(
        () => _i230.AuthServiceClient(gh<_i691.Transport>()));
    gh.lazySingleton<_i1024.DashboardServiceClient>(
        () => _i1024.DashboardServiceClient(gh<_i691.Transport>()));
    ...
    gh.lazySingleton<_i464.ExploreClient>(
        () => _i464.ExploreClient(gh<_i587.AnalyticsServiceClient>()));
    gh.lazySingleton<_i1026.AdminClient>(() => _i1026.AdminClient(
          gh<_i487.OrganizationServiceClient>(),
          gh<_i611.AdminServiceClient>(),
        ));
    gh.lazySingleton<_i512.DashboardState>(
        () => _i512.DashboardState(gh<_i1024.DashboardServiceClient>()));
    gh.lazySingleton<_i713.ExploreState>(() => _i713.ExploreState(
          gh<_i756.AnalyticsClient>(),
          gh<_i464.ExploreClient>(),
          gh<_i512.DashboardState>(),
        ));
    ...
    gh.lazySingleton<_i573.AuthClient>(
        () => _i573.AuthClient(gh<_i230.AuthServiceClient>()));
    gh.lazySingleton<_i567.AdminOrgState>(
        () => _i567.AdminOrgState(gh<_i1026.AdminClient>()));
    gh.lazySingleton<_i34.AdminState>(() => _i34.AdminState(
          gh<_i1026.AdminClient>(),
          gh<_i567.AdminOrgState>(),
        ));
    gh.lazySingleton<_i855.LocationsClient>(
        () => _i855.LocationsClient(gh<_i487.OrganizationServiceClient>()));
    gh.lazySingleton<_i234.MembersClient>(
        () => _i234.MembersClient(gh<_i487.OrganizationServiceClient>()));
    gh.lazySingleton<_i448.RolesClient>(
        () => _i448.RolesClient(gh<_i487.OrganizationServiceClient>()));
